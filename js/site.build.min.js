...
!function(){jQuery.fn.exists=function(){return this.length>0},$(document).ready(function(){function a(){return $(window).width()<=480}function b(){return Modernizr.touch}function c(a,b){var c=a.position().top;b&&(c-=Math.max(0,($(window).height()-a.outerHeight())/2)),$.scrollTo(c,{duration:2e3,easing:"easeOutExpo",axis:"y"})}function d(){b()?$(".arrow-wrap").hide():($(".section-me .arrow").tap(function(){c($(".section-projects"),!0)}),$(".section-projects .arrow").tap(function(){c($(".section-pubs"))}))}function e(){b()?($(".page-wrap").removeClass(".page-wrap"),$(".catan").addClass("catan-touch")):($(window).scroll(function(){var a=$(".section-pubs"),b=a.position().top+(a.outerHeight()-a.height())/2;$(this).scrollTop()>b?$(".section-pubs .title").addClass("stick-top"):$(".section-pubs .title").removeClass("stick-top")}),$.stellar({horizontalScrolling:!1,verticalOffset:40}))}function f(){var a=function(){var a=$(".splash-wrap"),c=$(window).width(),d=$(window).height(),e=Math.max(0,c/2-a.width()/2)+"px",f=Math.max(0,d/2-a.outerHeight()/2)+"px",g=b()?"relative":"fixed";a.css("position",g).css("left",e).css("top",f),a.attr("data-top",f)};$(window).resize(a),a()}function g(){a()||$(".project").hover(function(){var a=$(this);a.find(".info").fadeIn(),b()&&setTimeout(function(){a.find(".info").fadeOut()},2e3)},function(){var a=$(this);a.find(".info").fadeOut()})}function k(a){var b=a.find("#slider");if(b.exists()){var c=a.find("#position li");window.mySwipe=Swipe(b[0],{continuous:!0,auto:5e3,callback:function(a){setTimeout(function(){c.removeClass("on"),$(c[a]).addClass("on")},100)}}),$("nav li").tap(function(){window.mySwipe.slide($(this).attr("data-idx"))})}}function l(a,b){function e(){a.addClass("open");var d=$(j(h[b]));f(d),a.append(d),a.slideDown(c,function(){}),setTimeout(function(){k(d)},100)}function f(a,b){a.find("figure,nav").hide();var c=$("<div class='loading-spacer'></div><div class='loading center'><img src='./img/spinner.gif'/>Loading screenshots...</div>");a.find("#slider").append(c);var d=Date.now();$("#slider").imagesLoaded(function(){var e=750-(Date.now()-d);setTimeout(function(){a.find("#slider,figure,nav").fadeIn(),c.remove(),a.css({height:"auto"}),a.find("#slider").css({height:"auto"}),b&&b()},e)})}var c=500;if(a.hasClass("open")){var g=h[b],i=$(j(g));if(a.find(".overview").replaceWith(i.find(".overview")),!g.images||0==g.images.length)return a.find("#slider").remove(),a.find("nav").remove(),void 0;var l=a.find("#slider").exists(),m=$("#slider").height();l&&a.css("height",a.height()),a.find("#slider").remove(),a.find("nav").remove();var n=a.find(".details");n.append(i.find("#slider")),l&&a.find("#slider").height(m),n.append(i.find("nav")),f(a),k(a)}else e()}function m(){$(".active").removeClass("active"),$(".active-project").remove()}function n(a,b){var c=$("<div data-id='active-"+a+"' class='active-project'></div>");return c.insertAfter(b),c}function o(b){var c=b.attr("data-id");if(a()&&b.hasClass("active"))return $(".active-project[data-id='active-"+c+"']").slideUp(function(){b.removeClass("active"),$(this).remove()}),void 0;if(!b.hasClass("active")){if(a()||$(".project").removeClass("active"),b.addClass("active"),a())d=n(c,b);else{var d=$(".active-project");d.exists()||(d=n(c,$(".projects")))}l(d,c)}}function p(){$(".project").tap(function(){o($(this))});var a=null;$(window).resize(function(){a&&clearTimeout(a);var b=$(".project.active");b.exists()&&$(".active-project").remove(),a=setTimeout(function(){b.exists()&&(m(),o(b))},200)})}function q(){!function(a,b,c,d,e,f,g){a.GoogleAnalyticsObject=e,a[e]=a[e]||function(){(a[e].q=a[e].q||[]).push(arguments)},a[e].l=1*new Date,f=b.createElement(c),g=b.getElementsByTagName(c)[0],f.async=1,f.src=d,g.parentNode.insertBefore(f,g)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-42462226-1","chrishalaschek.com"),ga("send","pageview")}$("body,html").bind("scroll mousedown wheel DOMMouseScroll mousewheel keyup",function(a){(a.which>0||"mousedown"==a.type||"mousewheel"==a.type)&&$("html,body").stop()});var h={trendwars:{name:"Trend Wars",what:"iOS &amp; Android game to attack/defend things trending on Twitter",role:"Tech Lead (CTO &amp; Co-Founder @ <a href='http://hashgo.com' target='_blank'>HashGo</a>)",tech:"Unity3D, Node.js, Redis, MongoDB, AWS",status:"Launching August 2013",link:"http://trendwars.com",images:["./img/trendwars/tw1.jpg","./img/trendwars/tw2.jpg","./img/trendwars/tw3.jpg","./img/trendwars/tw4.jpg","./img/trendwars/tw5.jpg"]},clados:{name:"Conditionality",what:"Web-based investment research and portfolio management platform",role:"Tech Lead (CTO @ <a href='http://clados.com' target='_blank'>Clados</a>)",tech:"EXT-JS, Play Framework, Java, RDF triple store + custom inference algos, AWS",link:"http://clados.com",status:"Internal application"},phd:{name:"PhD Thesis",what:"Expressive Syndication on the Web",role:"Doctoral Student (University of Maryland)",tech:"OWL, Tableau reasoning alogrithms, Java",link:"http://drum.lib.umd.edu/bitstream/1903/7755/1/umi-umd-5037.pdf",status:"Published"},sideplay:{name:"Side Play",what:"Web-based second screen app for real-time picks and predictions",role:"Tech Lead (CTO &amp; Co-Founder @ <a href='http://hashgo.com' target='_blank'>HashGo</a>)",tech:"Backbone.js, Websockets, Node.js, Redis, MongoDB, AWS",status:"Internal proof-of-concept",images:["./img/sideplay/sp1.png","./img/sideplay/sp2.png","./img/sideplay/sp3.png","./img/sideplay/sp4.png","./img/sideplay/sp5.png","./img/sideplay/sp6.png","./img/sideplay/sp7.png","./img/sideplay/sp8.png"]},odr:{name:"Open Data Registry",what:"Supply chain traceability platform",role:"Advisor @ <a href='http://opendataregistry.com' target='_blank'>Open Data Registry</a>",tech:"Backbone.js, Node.js, RDF triple store",status:"Live",link:"http://opendataregistry.com/",images:["./img/odr1.png"]},rpt:{name:"Rock Paper Thing",what:"Web-based version of Rock Paper Scissors...and then some",role:"Tech Lead (CTO &amp; Co-Founder @ <a href='http://hashgo.com' target='_blank'>HashGo</a>)",tech:"CSS3, Backbone.js, Node.js, MongoDB, AWS",status:"Internal proof-of-concept",images:["./img/rpt/rpt1.png","./img/rpt/rpt2.png","./img/rpt/rpt3.png","./img/rpt/rpt4.png","./img/rpt/rpt5.png","./img/rpt/rpt6.png","./img/rpt/rpt7.png","./img/rpt/rpt8.png","./img/rpt/rpt9.png","./img/rpt/rpt10.png","./img/rpt/rpt11.png","./img/rpt/rpt12.png"]}},i='<div class="details">  <div class="overview">    <div class="name"><%=name%></div>    <div class="entry">      <div class="header">What:</div>      <div class="value"><%=what%></div>    </div>    <div class="entry">      <div class="header">Role:</div>      <div class="value"><%=role%></div>    </div>    <div class="entry">      <div class="header">Tech:</div>      <div class="value"><%=tech%></div>    </div>    <div class="entry">      <div class="header">Status:</div>      <div class="value">      <%if(typeof link !=\'undefined\'){%>         <a href=\'<%=link%>\' target=\'_blank\'><%=status%></a>      <%}else{%>       <%=status%>      <%}%>        </div>    </div>  </div>  <%if(typeof images !=\'undefined\' && images.length > 0){%>  <div id=\'slider\' class=\'swipe\'>    <div class=\'swipe-wrap\'>   <%for(var i = 0; i < images.length; i++){%>      <figure>        <div class=\'wrap\'>          <img src="<%=images[i]%>" />        </div>      </figure>    <%}%>    </div>  </div>  <nav>   <ul id=\'position\'>   <%for(var i = 0; i < images.length; i++){%>     <li data-idx="<%=i%>" class=\'<%=i==0? "on" : ""%>\'></li>    <%}%>   </ul>  </nav>  <%}%>',j=_.template(i);e(),f(),p(),d(),g(),q()})}();